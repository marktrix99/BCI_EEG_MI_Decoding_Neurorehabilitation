...
% calibration signal
folderName = 'C:\Users\LENOVO\Documents\Uni\Master Thesis\ISR_Data\Test_03_07_2025\Calibração\Marko_03_07_rest_middle_HOH\20250703_112421';
start_sec = 0.5;
end_sec = 2.5;
movement_comb = [3 4];
fs = 256;
...
for i = 1:length(filter_list)
    ...
    [~, ~, acc_closed, std_closed]     = ac_classification_model_fbcsp(folderName, csp_para, fs, start_sec, end_sec, 1, 3, N_channels, Window_buff, T_task_class, classes, chunk_length_sec);
    [~, ~, acc_opened, std_opened]     = ac_classification_model_fbcsp(folderName, csp_para, fs, start_sec, end_sec, 1, 4, N_channels, Window_buff, T_task_class, classes, chunk_length_sec);
    [~, ~, acc_movement, std_movement] = ac_classification_model_fbcsp(folderName, csp_para, fs, start_sec, end_sec, 1, movement_comb, N_channels, Window_buff, T_task_class, classes, chunk_length_sec);
