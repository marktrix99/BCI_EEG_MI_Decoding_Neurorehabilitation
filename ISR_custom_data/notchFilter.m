function trials_filt = notchFilter(trials, fc, fs)
%     Designs and applies a bandpass filter to the signal.
%     arguments:
%         trials      - An array (channels x samples x trials) containing the signal
%         fc          - Frequency to eliminate(in Hz)
%         fs          - Sample rate of the signal (in Hz)
%     returns:
%         An array (channels x samples x trials) containing the notch
%         filtered signal
    ...
    [a,b] = butter(3,[fc-1 fc+1]./(fs/2),'stop');
